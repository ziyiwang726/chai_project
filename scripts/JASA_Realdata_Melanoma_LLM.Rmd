...
# Knit this file from the project root (Knit > Knit Directory > Project).
```
...
# ggsave("./plots/Gopalakrishnan/16s_wilcoxz_LLM_family_updated.png", plot = p_LLM, width = 8, height = 5, dpi = 300)


# pdf("./plots/Gopalakrishnan/16s_LLM_heatmap.pdf", width = 8, height = 6)
# 
# draw(
#   ht,
#   heatmap_legend_side = "right",
